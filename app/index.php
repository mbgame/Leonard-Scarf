...
<link rel="canonical" href="https://www.leonardscarf.com/app/index.php" />
<link rel="alternate" href="https://www.leonardscarf.com/app/index.php" hreflang="fa-ir" />
<meta name='description' content='دانلود نرم افزار های مورد نیاز شبکه های اجتماعی مانند تلگرام و اینستاگرام با لینک مستقیم در سایت شال و روسری لئونارد'>
...
h2.rules {font-family: 'Tahoma', Arial, sans-serif; font-weight: 200; font-size: 22px; margin-top: 50px; margin-right: 30px;margin-bottom:20px; color: #b48608;}
...
.imagetop{width:80%;margin:0 auto;margin-bottom:5%;}
.dllink{color:#000;border:2px solid #fff;border-radius: 25px;background-color:#fff;padding:10px;margin:30px;-webkit-transition: background 0.5s ease;-moz-transition: background 0.5s ease;-o-transition: background 0.5s ease;-ms-transition: background 0.5s ease;transition: background 0.5s ease;}
.dllink:hover{background-color:#999;color:#fff;border:#b48608;}
}
</style>
</head>
<body>
...
<h1><strong>آرشیو روسری نخی</strong> لئونارد </h1>
</div>
...
<div class="imagetop">
<img src="https://www.leonardscarf.com/app/images/telegram.jpg" alt="تلگرام" title="تلگرام"/>
</div>
<h2 class="rules">دانلود آخرین نسخه تلگرام برای گوشی های اندروید</h2>
<a class="dllink" href="https://play.google.com/store/apps/details?id=org.telegram.messenger" title="دانلود برای انروید">Download Telegram 4.1</a>
<h2 class="rules">دانلود با لینک مستقیم</h2>
<a class="dllink" href="https://www.leonardscarf.com/app/telegram[leonardscarf.com].apk" title="دانلود مستقیم">دانلود با لینک مستقیم</a>
<h2 class="rules">دانلود آخرین نسخه تلگرام برای آیفون و آیپود</h2>
<a class="dllink" href="https://itunes.apple.com/us/app/telegram-messenger/id686449807?mt=8" title="دانلود برای ایفون">Download Telegram 4.1 for iphone</a>
